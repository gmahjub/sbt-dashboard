...
dash.register_page(__name__, path='/RateVolSignal', name='Rate Vol Signal') # Home Page
...
name_contains_str = "name contains 'SB Trades - Rate Volatility - Notes & Observations'"
rate_vol_notesObs = get_data.get_trade_plans(name_contains=name_contains_str)
####################################
# Page layout
####################################
...
layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col(
            dcc.Graph(figure=data_viz.sbt_heatmap(df_ms)),
            xs=12,sm=12,md=12,lg=12,xl=12,xxl=6,class_name=('mt-4')),

        dbc.Col(dcc.Graph(id='rate_volatility_graph'),
            xs=12,sm=12,md=12,lg=12,xl=12,xxl=6,class_name=('mt-4')),
    ]),
